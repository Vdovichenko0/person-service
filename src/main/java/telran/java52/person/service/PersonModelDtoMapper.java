...
public class PersonModelDtoMapper {//преобразует из person > personDto и наоборот
	final ModelMapper modelMapper;
	
	public Person mapToModel(PersonDto personDto) {
		if (personDto instanceof ChildDto) { //если тип child то сохраняй в child
	...
	public PersonDto mapToDto(Person person) {
		if (person instanceof Child) { //если тип child то вeрни ChildDto
